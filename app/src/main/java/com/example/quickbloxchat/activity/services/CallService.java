package com.example.quickbloxchat.activity.services;
...
import com.example.quickbloxchat.utils.ChatPingAlarmManager;
            ...
            chatService.login(qbUser, new QBEntityCallback<QBUser>() {
                ...
                public void onError(QBResponseException e) {
                    ...
                    try {
                        ...
                        Toast.makeText(CallService.this, "Check Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }catch (Exception e){
